...
import com.app.tiffinapp.utils.Utility.openNavDrawer
...
class UserActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBuyOnceZOne.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        if (v == btnSubscription) {
            val i = Intent(baseContext, SubscriptionZone::class.java)
            startActivity(i)
        } else if (v == btnBuyOnceZOne) {
            val i = Intent(baseContext, BuyOnceZone::class.java)
            startActivity(i)
